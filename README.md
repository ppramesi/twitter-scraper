...
[![Go Reference](https://pkg.go.dev/badge/github.com/ppramesi/twitter-scraper.svg)](https://pkg.go.dev/github.com/ppramesi/twitter-scraper)
...
```shell
go get -u github.com/ppramesi/twitter-scraper
```
